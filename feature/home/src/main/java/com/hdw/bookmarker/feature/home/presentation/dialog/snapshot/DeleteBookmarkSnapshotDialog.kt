package com.hdw.bookmarker.feature.home.presentation.dialog.snapshot
...
@Composable
fun DeleteBookmarkSnapshotDialog(snapshotTitle: String, onDismiss: () -> Unit, onConfirmDelete: () -> Unit) {
    AlertDialog(
