package com.hdw.bookmarker.feature.importguide.presentation.component.detail
...
@Composable
fun Browser.toStep1GuideContent(resolvedBrowserName: String, showDesktopGuideButton: Boolean): Step1GuideContent =
    when (this) {
        Browser.CHROME -> {
            Step1GuideContent(
